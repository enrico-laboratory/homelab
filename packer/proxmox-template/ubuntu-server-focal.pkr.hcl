...
source "proxmox-iso" "ubuntu-server-focal" {
  ...
  iso_file = "truenas-iso-nfs:iso/ubuntu-20.04.6-live-server-amd64.iso"
  # - or -
...
#  iso_checksum = "b8f31413336b9393ad5d8ef0282717b2ab19f007df2e9ed5196c13d8f9153c8b"
  iso_storage_pool = "truenas-iso-nfs"
  unmount_iso = true
  ...
  http_bind_address = "192.168.2.3"
  http_port_min = 8802
  http_port_max = 8802

  ssh_username = "eruggieri"
